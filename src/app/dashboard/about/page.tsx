                ...
                return (
                    <>
                        <div className=''>
                            ...
                            {/* Add New Question button - (Adds a component with Forms) */}
                            <div className="mt-6">
                                <div className="flex space-x-6 w-full">
                                ...
                                <div className='py-3 space-y-6'>
                                    ...
                                    <div>
                                        ...
                                        <Field as='select' className="w-full px-4 py-2 border rounded-md">
                                            <option value="0" disabled={false} className="text-gray-400">Next Question, if
                                                added
                                            </option>
                                            <option className="disabled:cursor-not-allowed" value="-2" disabled={true}>-- No
                                                questions --
                                            </option>
                                            <option className="disabled:cursor-not-allowed" value="-1">End Survey
                                            </option>
                                        </Field>
                                    </div>
                                    <hr/>
            ...
            >
                {({
                    ...
                    <Form className='bg-white p-6'>
                        {RenderForm(touched, errors, values)}
                        <div className='py-6'>
                            <Transition
                                as={"div"}
                                show={form < 1}
